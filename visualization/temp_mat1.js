...
function timelineRect() {
    ...
    .click(function (d, i, datum) {
    	time = +d.starting_time; // convert a Date object to time in milliseconds
        date = new Date(time);
		var url = "_"+"TITLE";
	...
	//Formatting how the timeline looks on the page				
    ...
    tickSize: 5
      ...
      .stack();
    var svg = d3.select("#timelinet").append("svg").attr("width", width)
      .datum(b).call(chart);
        d3.select("svg").select("g").attr("transform", "translate(80,-18)")
  }
